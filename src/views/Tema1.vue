...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.container.justify-content-around.align-items-center.mt-3
        ...
        .tarjeta.p-4
            figure
                img(src='@/assets/curso/temas/img-fondo-slider1.png', alt='Texto que describa la imagen').img-fondo-slider1
    ...
    .row.container.justify-content-around.align-items-center.mt-5
        ...
        TabsC.color-primario
          ...
          .py-3.py-md-4(titulo="Empalme cola de rata")
            .row
    ...
    .row.container.justify-content-around.align-items-center.mt-5
        ...
        p El enrollado de cables de alto voltaje puede llevar mucho tiempo y ser propenso a errores, la cinta requiere amoladoras de precisión y tensión constante para reducir los espacios de aire que se producen.
        

        .tarjeta.fondo-slider2-tema1.p-4
          ...
          SlyderA(tipo="b")
            ...
            .row.justify-content-center.align-items-center.my-lg-4
              ...
              .col-md-6.mb-4.mb-md-0
                p.txt-slider2-tema1 Los plásticos están diseñados para estirarse hasta un 1000%. Al estirar la cinta de esta manera, se comprime y se crea una aleación fuerte que proporciona un excelente aislamiento y protección contra la humedad. En un tejido típico, hay tiras de la tela hacia adentro y hacia afuera, estirándola justo antes del punto de rotura. El ancho de la cinta se reduce a aproximadamente 1/3 del tamaño original.

              .col-md-6

                h4.txt--titu-slider2-tema1 Cables enrollados 
            ...
            .row.justify-content-center.align-items-center.my-lg-4
              ...
              .col-md-6.mb-4.mb-md-0
                p.txt-slider2-tema1 La longitud de la cinta aumenta y, a menudo, se verá envuelto en un aprieto, lo que hará que la tarea sea más difícil. El enfoque correcto es crucial para obtener los muchos beneficios de escalar. La presión, incluso con el estiramiento, ayuda a eliminar los espacios y las protuberancias, a veces denominadas "articulaciones del embarazo".

              .col-md-6

                h4.txt-slider2-tema1 Cableado
            ...
            .row.justify-content-center.align-items-center.my-lg-4
              ...
              .col-md-6.mb-4.mb-md-0
                p.txt-slider2-tema1 Una buena banda elástica no se romperá después de enrollarse durante la construcción. Las uniones y conectores siempre deben cubrirse con cinta para protegerlos de la contaminación química y daños físicos. 

              .col-md-6

                h4.txt--titu-slider2-tema1 Falla en tuberías
                figure
            ...
            .row.justify-content-center.align-items-center.my-lg-4
              ...
              .col-md-6.mb-4.mb-md-0
                p.txt-slider2-tema1 El revestimiento de vinilo evita que se acumule la suciedad en el cable. La rigidez dieléctrica de las bandas de goma aumenta con la adición de capas. Para aplicaciones de bajo voltaje (<600 V), siempre debe cubrir un mínimo de 2½ capas con las mitades superpuestas.

              .col-md-6

                h4.txt--titu-slider2-tema1 Rigidez dieléctrica
    ...
    br
    .row.container.justify-content-around.align-items-center.fondo-conex-embrag.p-4
    
        .col-lg-6

            h4.txt-conex-embrag Conexiones de embrague

            p Dentro de las consideraciones para que las conexiones sean eficientes están:

            ul.lista-ul--color
                li 
                  i.fas.fa-angle-right.txt-conex-embrag
                  | Realizar la medida del tornillo o sitio donde se va a introducir el conector.
                li 
                  i.fas.fa-angle-right.txt-conex-embrag
                  | En el caso de los tornillos, realizar la conexión en el sentido donde se aprietan, para que la presión los asegure y no se salgan.
                li 
                  i.fas.fa-angle-right.txt-conex-embrag
                  | No dejar conductores por fuera del elemento en el cual se realiza la conexión.
                li 
                  i.fas.fa-angle-right.txt-conex-embrag
                  | Cuando el alambre está compuesto de varios filamentos, antes de insertarlo, se deben entrelazar, para darle más consistencia y evitar que alguno de estos hilos quede suelto.
        ...
        .row.fondo-pto-caliente.p-4
          ...
          ImagenInfografica.color-primario
            template(v-slot:imagen)
              figure
                img(src='@/assets/curso/temas/img-pto-cal-tema1.png', alt='Texto que describa la imagen').img-pto-cal-tema1
                //figcaption Leyenda de la imagen
            ...
            .tarjeta.color-tarj-pto-color.p-3(x="30%" y="95%" numero="6")
              ...
              p Según estos riesgos, en el proceso de revisión se valida que estén las medidas de prevención y de corrección para que no ocurran incidentes dentro de una instalación eléctrica.  
            ...
            .tarjeta.color-tarj-pto-color.p-3(x="15%" y="20%" numero="9")
              //.h5.mb-2 titulo
    ...
    .row.container.justify-content-around.align-items-center.mt-5
        ...
        .row.fondo-validac-planos2.p-4
          ...
          .col-lg-6
              ...
              figure
                  img(data-aos="fade-left")(src='@/assets/curso/temas/img-planific.png', alt='Texto que describa la imagen').img-planific
          ...
          .col-lg-6
              ...
              h4 Planificación
              p Este es un paso preliminar en donde se establecen las actividades que se van a realizar durante la inspección. Estos son los eventos que se deben definir:
          ...
          .row.justify-content-center.mb-4
            .col-lg-5
              figure(data-aos="zoom-in")
                img(src="@/assets/curso/temas/img-cableado-estruc.png", alt="alt").img400.m-auto
            .col-lg-7
              AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta fondo-sup-acord")
                .row(titulo="Elemento cableado horizontal")
                  .col-12
                    p.mb-0 Es la parte del cableado estructurado que corresponde a los alambres de red y eléctricos, se extiende desde el cuarto de telecomunicaciones hasta el puesto de trabajo. Este tipo de configuración es la parte del cableado estructurado que contiene la mayor cantidad de cables individuales, los cuales se incluyen las salidas que van a las cajas y conectores, y los paneles de empalme utilizados para configurar las conexiones del cableado en los cuartos de telecomunicaciones.  (Ortiz ,J,2014)     
        ...
        .row.fondo-buenas-practicas.bloque-pract-manip.p-4
          ...
          .col-lg-6
                ...
                ul.lista-ul--color
                  li 
                    i.fas.fa-angle-right
                    | Los estándares, en su mayoría internacionales, proporcionan un marco sólido y confiable a la hora de llevar adelante un proyecto de cableado.


                  li 
                    i.fas.fa-angle-right
                    | Las normas siempre son actualizadas y monitoreadas por comités, de modo que cualquier empresa puede solicitar una revisión o participar de la revisión de estas. (Hernández-Reverol, D., Fuentes-Méndez, L., y Torres-Granadillo, F,2011)
    ...
    .row.container.justify-content-around.align-items-center.mt-5
        ...
        .row.fondo-tarj-final.tarjeta.bloque-tarj-final.p-4
            
            .col-lg-2
                figure
                      img(src="@/assets/curso/temas/im-enchufe.png", alt="alt").im-enchufe


            .col-lg-8

                p.txt-tarj-final Para ampliar la información, lo invitamos a ver el #[strong  Anexo 1. Cálculo, propuesta y costo] donde se detallan los elementos que componen una propuesta de valor unitario y los elementos que componen una propuesta de cableado estructurado con sus respectivos costos.


            .col-lg-2
              .boton-tarj-final
                a.boton.boton--b(:href="obtenerLink('/downloads/anexo_CF20.pdf')" target="_blank")
                    span Descargar
    ...
    datosSlyder: [
      {
        titulo: 'Tuberías',
        texto:
          'Se deben revisar las tuberías, verificar que no estén obstruidas para poder cablear. En el caso de estar taponadas se procede a realizar la limpieza de estas.',
        imagen: require('@/assets/curso/temas/img1-slider-img-tema1.png'),
        // leyendaImagen: 'Leyenda de la imagen',
      },
      {
        titulo: 'Cajas limpias',
        texto:
          'Limpiar las cajas sacando el material de protección y las partes de mortero que hayan quedado, de tal forma que el espacio quede limpio y las entradas de los tubos también.',
        imagen: require('@/assets/curso/temas/img2-slider-img-tema1.png'),
        // leyendaImagen: 'Leyenda de la imagen',
      },
      {
        titulo: 'Sonda para limpiar',
        texto:
          'Se introduce la sonda desde la punta inicial hasta la punta final.',
        imagen: require('@/assets/curso/temas/img3-slider-img-tema1.png'),
        // leyendaImagen: 'Leyenda de la imagen',
      },
      {
        titulo: 'Limpieza de tuberías',
        texto:
          'Luego, se introduce un elemento de tela para secar el tubo por dentro en el caso de que haya humedad; si la hay esto se hace varias veces hasta que la humedad desaparezca.',
        imagen: require('@/assets/curso/temas/img4-slider-img-tema1.png'),
        // leyendaImagen: 'Leyenda de la imagen',
      },
      {
        titulo: 'Sonda de tubería',
        texto:
          'Se unen los cables a la sonda eléctrica, la cual se introduce primero y, luego, se pasan los cables a través del tubo. Se unta parafina a los conductores para que su travesía dentro del tubo sea más suave y no tengan resistencia.',
        imagen: require('@/assets/curso/temas/img5-slider-img-tema1.png'),
        // leyendaImagen: 'Leyenda de la imagen',
      },
      {
        titulo: 'Sonda',
